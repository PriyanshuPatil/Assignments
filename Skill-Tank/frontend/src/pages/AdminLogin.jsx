...
const AdminLogin = () => {
  ...
  const [user_data,setUserData]=useState({email:"",password:"",username:"",admin:true});
...
const login_call=()=>{
 if(login_active){
  ...
  return (
   ...
   <Heading textAlign={'center'} p={'10px'} fontSize={'30px'} fontWeight={'600'}>{login_active?"Company Loging Form":"Company Signup Form"}</Heading>
