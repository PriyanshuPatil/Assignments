...
import { DELETE_CONTACT_ERROR, DELETE_CONTACT_LOADING, DELETE_CONTACT_SUCCESS, GET_CONTACT_ERROR, GET_CONTACT_LOADING, GET_CONTACT_SUCCESS, GET_SINGLE_CONTACT_ERROR, GET_SINGLE_CONTACT_LOADING, GET_SINGLE_CONTACT_SUCCESS, POST_CONTACT_ERROR, POST_CONTACT_LOADING, POST_CONTACT_SUCCESS, UPDATE_CONTACT_ERROR, UPDATE_CONTACT_LOADING, UPDATE_CONTACT_SUCCESS } from "./phonebookReducer.type";
...
const datais={storage:data.storage,first_name:data.first_name,last_name:data.last_name,phone_number:data.phone_number,email:data.email,home:data.home,image:data.image==""?"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSaHmgseRqO6CI14XWSh5swCN19tzNhtgptvg&usqp=CAU":data.image,mobile_number:data.mobile_number}
...
export const delete_Contact_Axios = (id,toast,setchangeDetails) => async (dispatch) => {
...
export const update_Contact_Axios = (id, data,toast,setchangeDetails) => async (dispatch) => {
