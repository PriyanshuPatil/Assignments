    ...
    switch (type) {
      ...
      case UPDATE_CONTACT_SUCCESS: {
        let updated_data=state.contactData.map((el)=>{
            if(el._id!=payload.id){return el}else{
          return payload.data ;
            }  
          })
          return { ...state, loading: false, error: false,contactData:updated_data };
      }
      ...
      case POST_CONTACT_SUCCESS: {
        return { ...state, loading: false, error: false,contactData:[...state.contactData,payload] };
      }
      ...
      case DELETE_CONTACT_SUCCESS: {
        ...
        return { ...state, loading: false, error: false,contactData:deleted_data };
      }
